...
<div id="documentWrapper" class="container column" style="margin-top: 325px">
    ...
    <div class="titleDiv shape-diamond blackText div" style="border-radius: 0; min-height: 50px; top: 10px;"><h1>City
            Pop Archives</h1></div>
    ...
    <div id="searchBar" class="row pop">
        <form action="../search" method="post">
            <input type="text" style="flex-grow: 1" onkeyup="if(event.key==='Enter') console.log();"
                   placeholder="Search for artists, songs, cities or albums.">
            <button type="submit" class="retroButton"><i class="material-icons">search</i></button>
        </form>
    </div>
    ...
    <!-- INFO BOX -->
    <div id="textBox" style="width: 50vw; font-size: 14pt;" class="frame leanUpRightPerma leanNormal secondaryVariant hoverFillPrimary">
        <h1 class="title">City Pop</h1>
        <p ><a
                    href="https://www.nippon.com/en/japan-topics/g00631/a-guide-to-city-pop-the-soundtrack-for-japan%E2%80%99s-bubble-era-generation.html">City
                Pop</a> is a genre of music popular in Japan in the late 70s and 80s blending pop, jazz, and funk to
        ...
        <p><a href="https://www.vice.com/en_au/article/mbzabv/city-pop-guide-history-interview" class="smallText">The Guide to Getting Into City Pop, Tokyo’s Lush 80s Nightlife Soundtrack</a></p>
        <blockquote> City Pop was the soundtrack to the dream like, optimistic state that the country was enjoying.
            The swinging beats and soft jazzy soundscapes of City Pop set the tone for an interim that although wasn’t
            to last, existed as a fantastical dream world for a time. </blockquote>
    </div>
    ...
    <div id="testingDiv" class="secondaryVariant">
        ...
        <form action="../0PHP/test.php" method="post">
