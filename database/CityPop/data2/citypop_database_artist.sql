...
CREATE TABLE `artist` (
  ...
  `imgURL` varchar(200) COLLATE utf8_bin DEFAULT NULL,
...
INSERT INTO `artist` VALUES (1,'Tatsuro','Yamashita',1953,NULL,'https://aramajapan.com/wp-content/uploads/2017/07/aramajapan.com-tatsuroreborn-promo.jpg',NULL),(2,'Mariya','Takeuchi',1955,NULL,'https://cdfront.tower.jp/~/media/Images/Article/News/tg/2019/04/22/tg009.jpg?h=320&w=467&la=ja-JP',NULL),(4,'Meiko','Nakahara',1959,NULL,NULL,NULL),(5,'Haruomi','Hosono',1947,NULL,NULL,NULL),(6,'Masayoshi','Takanaka',1953,NULL,NULL,NULL),(7,'Toshiki','Kadomatsu',1960,NULL,NULL,NULL),(8,'Hiromi','Iwasaki',1958,NULL,NULL,NULL),(9,'Yoshimi','Iwasaki',1961,NULL,NULL,NULL),(10,'ANRI','(杏里)',1961,NULL,NULL,NULL);
