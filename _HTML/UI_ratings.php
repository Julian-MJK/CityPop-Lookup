...
<!-- RATINGS -->
<div id="ratingDiv" class="secondary noselect">
    ...
    <p id="rating_avgP"> <?php echo isset($ratings->average) ? $ratings->average . '/5 average (' . $ratings->total . ' rating' . ($ratings->total > 1 ? 's' : '') . ')' : 'This ' . $subject . ' has no ratings.'; ?> </p>

    <form id="submitRatingForm" action="../_PHP/user/rate.php" method="post" class="alignCenter column" style="display: flex; width: 100%">
